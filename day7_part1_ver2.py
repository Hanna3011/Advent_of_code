...
def find_sum_at_most_100000_content():
    ...
    sum_at_most_100000_content = 0
    for key in value_dict.keys():
        if type(key) == int and key != 1:
            if value_dict[key] <= 100000:
                sum_at_most_100000_content += value_dict[key]
    return sum_at_most_100000_content

print(find_sum_at_most_100000_content())